 ...
 * @author asus
 */
public class GetInteractListServlet extends HttpServlet {
@Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //调用查询
            JSONArray mInteractList = queryPoint(Cid);
            JSONObject jsonObject = new JSONObject();
            Map<String,JSONArray> params = new HashMap<>();
            params.put("Interacts", mInteractList);
    ...
    private JSONArray queryPoint(String Cid) {
        return InteractDao.queryClassInteract(Cid);
    }
}